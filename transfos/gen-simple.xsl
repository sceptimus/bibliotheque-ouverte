...
<!--
  saxon -s:bd/articles-bib.xml -xsl:transfos/gen-simple.xsl -o:dist/articles.html
   -->
...
span.Tag {
  ...
  margin: 0 5px;
        ...
        <body>
          <div style="margin: 2em">
            <h1>Articles</h1>
            <p>
              Liste publiée à partir du canal télegram " <b>Répertoire de Résistants</b> " 
            </p>
  ...
  <xsl:template match="Nom[empty(following-sibling::Nom)]"><xsl:text> &amp; </xsl:text><xsl:value-of select="."/>
  </xsl:template>
